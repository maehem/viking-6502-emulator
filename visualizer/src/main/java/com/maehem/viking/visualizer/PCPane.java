 ...
 */
public class PCPane extends GridPane {
    ...
    public PCPane() {
        ...
        // Label Column
        Label pcLabel = new FlagLabel("PC:", "Program Counter");
        Label blankLabel = new FlagLabel("", "");
        Label spLabel = new FlagLabel("S:", "Stack Pointer");
        ...
        // Value Column
        Label pcVal = new FlagValue("FFFF", "Program Counter");
        Label blankVal = new FlagValue("", "");
        Label spVal = new FlagValue("01 FF", "Stack Pointer");
